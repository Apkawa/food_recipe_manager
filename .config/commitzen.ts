...
module.exports = {
  ...
  scopes: [
    {name: 'core'},
    {name: 'core:recipe-parse'}, // Логика разбора рецепта
    {name: 'core:recipe-calculate'}, // Логика пересчета рецепта
    {name: 'core:calculate-units'}, // Логика пересчета единиц измерения
    {name: 'core:recipe-export'},
    {name: 'core:recipe-import'},
